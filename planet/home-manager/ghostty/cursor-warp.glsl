// Based on: https://github.com/sahaj-b/ghostty-cursor-shaders/blob/4faa83e4b9306750fc8de64b38c6f53c57862db8/cursor_warp.glsl
...
const float THRESHOLD_MIN_DISTANCE = 0.8; // min distance to show trail (units of cursor height)
